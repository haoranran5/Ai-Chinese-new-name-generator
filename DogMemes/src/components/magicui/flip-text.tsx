...
interface FlipTextProps extends MotionProps {
  ...
  as?: ElementType;
  /** The word to animate (alternative to children) */
  word?: string;
...
export function FlipText({
  ...
  // Use word prop if provided, otherwise use children
  const text = word || (children ? React.Children.toArray(children).join("") : "");
